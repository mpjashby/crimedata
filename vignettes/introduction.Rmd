...
The goal of the crimedata package is to access police-recorded crime data from 
large US cities using the [Crime Open Database](https://osf.io/zyaqn/) (CODE), a 
service that provides these data in a convenient format for analysis. All the 
data are available to use for free as long as you acknowledge the source of the 
data.
...
``` r
# if necessary, install devtools to enable downloading of packages from GitHub
# install.packages("devtools")

# install crimedata package
