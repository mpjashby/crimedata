...
[![Build Status](https://travis-ci.org/mpjashby/crimedata.svg?branch=master)](https://travis-ci.org/mpjashby/crimedata)
[![codecov](https://codecov.io/gh/mpjashby/crimedata/branch/master/graph/badge.svg)](https://codecov.io/gh/mpjashby/crimedata)
 
---
 
[![minimal R version](https://img.shields.io/badge/R%3E%3D-3.2.0-6666ff.svg)](https://cran.r-project.org/)
[![CRAN_Status_Badge](http://www.r-pkg.org/badges/version/crimedata)](https://cran.r-project.org/package=crimedata)
...
```{r include=FALSE}
badgecreatr::badgeplacer(githubaccount = "mpjashby", githubrepo = "crimedata")
```
